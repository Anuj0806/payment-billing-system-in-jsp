...
out.print("<tr><td><B>ID</B></td><td><B>Name</B></td><td><B>Course</B></td><td><B>Mobile</B></td><td><B>Date Of Submission</B></td><td><B>Paid</B></td><td><B>Fee</B></td><td><B>Balance</B></td><td><B>Grand Total</B></td><td><B>Address</B></td><td><B>F. Name</B></td><td><B>M, Name</B></td><td><B>D.O.B</B></td><td><B>Qualification</B></td><td><B>Date Of Joining</B></td><td><B>Description</B></td><td><B>Trainer</B></td></tr>");
while(rs.next()){
...
out.print("<td><a  href=updatedata.jsp?email="+id+">Update Data</a></td>");
out.print("</tr>");
}
out.print("</table>");
con.close();
