...
<tr><td><B>ID:</B></td><td><input type="text" required="" name="id"></input></td></tr>
<tr><td><B>Name:</B></td><td><input type="text" required name="name" ></input></td></tr>
<tr><td><B>Course:</B></td><td><select name="course"   id="cc_name" >
...
<tr><td><B>Mobile:</B></td><td><input type="text" required name="mobile"></input></td></tr>
<tr><td><B>Father's Name:</B></td><td><input type="text" required name="fathername"></input></td></tr>
<tr><td><B>Mother's Name:</B></td><td><input type="text" required name="mothername"></input></td></tr>
<tr><td><B>Qualification:</B></td><td><input type="text" required name="qualification"></input></td></tr>
<tr><td><B>Date of Birth:</B></td><td><input type="date" required name="dateofbirth"></input></td></tr>
<tr><td><B>Date of Joining:</B></td><td><input type="date" required name="dateofjoining" ></input></td></tr>
<tr><td><B>Date of Submission:</B></td><td><input type="date" readonly="" value="<%=current_date%>" required name="feesub" ></input></td></tr>
<tr><td><B>Paid:</B></td><td><input type="text" required value="0" readonly="" name="paid" ></input></td></tr>
<tr><td><B>Fee:</B></td><td><input type="text" required  name="fee" ></input></td></tr>
<tr><td><B>Address:</B></td><td><input type="text" required name="address"></input></td></tr>
<tr><td><B>Description:</B></td><td><input type="text" required name="description"></input></td></tr>
<tr><td><B>Trainer:</B></td><td><input type="text" required name="trainer"></input></td></tr>
