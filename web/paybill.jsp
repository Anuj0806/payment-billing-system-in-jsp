...
%>
<h3 style="color: navy;" align="center"><B>Pay Bill Form</B></h3>
<div id="box">

<form  action="paybill1.jsp"  name="myform" id="hello"  method="post">
<table width="100%">
<tr>
...
<tr><td><B>ID:</B></td><td><input type="number" value="<%=id%>" required="" readonly="" name="id"></input></td></tr>
<tr><td><B>Name:</B></td><td><input type="text" value="<%=name%>"  required readonly="" name="name" ></input></td></tr>
<tr><td><B>Course:</B></td><td><select disabled name="course" >
...
<tr><td><B>Date of Joining:</B></td><td><input type="date" value="<%=doj%>" readonly="" required name="dateofjoining" ></input></td></tr>
<tr><td><B>Date of Submission:</B></td><td><input type="date" readonly="" value="<%=current_date%>" required name="feesub" ></input></td></tr>
<tr><td><B>Paid:</B></td><td><input type="number" required value="<%=paid%>" readonly="" name="paid" ></input></td></tr>
<tr><td><B>Fee:</B></td><td><input type="number" required name="fee"  ></input></td></tr>
<tr><td><B>Balance:</B></td><td><input type="number" required name="balance" readonly="" value="<%=balance%>" ></input></td></tr>
<tr><td><B>Grand Total</B></td><td><input type="number" required name="balance" readonly="" value="<%=grandt%>" ></input></td></tr>
